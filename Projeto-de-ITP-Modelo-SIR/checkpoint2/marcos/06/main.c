...
//VERIFICA ERROS DE PASSAGEM DE PARÂMETROS DE ENTRADA PELA LINHA DE COMANDO
    if(cont2>0) {
        printf("\n");
        lista_parametros();
        printf("\n");
...
//COPIA PARÂMETROS PARA VETORES A SEREM USADOS NOS DEMAIS CENÁRIOS
    c[1] = c[2] = c[0];
...
//*** CENÁRIO 1 ***
    ...
    //TRANSIÇÃO PARA NOVO PARÂMETRO DE T_b.
    c[1].T_b = c[1].T_b2;
...
//*** CENÁRIO 2 ***
    ...
    //TRANSIÇÃO PARA NOVO PARÂMETRO DE T_k.
    c[2].T_k = c[2].T_k2;
